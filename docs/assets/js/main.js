...
const cdesign = document.querySelector(".js-cdesign"),
  cfill = document.querySelector(".js-cfill"),
  cshare = document.querySelector(".js-cshare"),
  contentDesign = document.querySelector(".js-design"),
  contentFill = document.querySelector(".js-fill"),
  contentShare = document.querySelector(".js-share"),
  arrowDesign = document.querySelector(".js-arrowD"),
  arrowFill = document.querySelector(".js-arrowF"),
  arrowShare = document.querySelector(".js-arrowS");
...
function showDesign() {
  hiddenDesign(),
    contentDesign.classList.contains("js-design") &&
...
function showFill() {
  hiddenFill(),
    contentFill.classList.contains("js-fill") &&
      (contentDesign.classList.add("hidden"),
      contentShare.classList.add("hidden"),
...
function showShare() {
  hiddenShare(),
    contentShare.classList.contains("js-share") &&
      (contentDesign.classList.add("hidden"),
      contentFill.classList.add("hidden"),
      arrowDesign.classList.add("arrowhidden"),
      arrowFill.classList.add("arrowhidden"));
...
const palette1 = document.querySelector(".palette-1"),
  palette2 = document.querySelector(".palette-2"),
  palette3 = document.querySelector(".palette-3"),
...
function labelpalette1() {
  card.line.classList.add("js-color2"),
    ...
    card.border.forEach((e) => e.classList.add("js-color3")),
    card.border.forEach((e) => e.classList.remove("js-color6", "js-color9")),
...
function labelpalette2() {
  card.line.classList.add("js-color5"),
    ...
    card.border.forEach((e) => e.classList.add("js-color6")),
    card.border.forEach((e) => e.classList.remove("js-color3", "js-color9")),
...
function labelpalette3() {
  card.line.classList.add("js-color8"),
    ...
    card.border.forEach((e) => e.classList.add("js-color9")),
    card.border.forEach((e) => e.classList.remove("js-color6", "js-color3")),
    card.icon.classList.add("js-color4"),
    card.icon.classList.remove("js-color1", "js-color7"),
    (FormData.palette = "3");
}
...
form.addEventListener("keyup", changeTitle), console.log(">> Ready :)");
